            ...
            <div className="mt-4 flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
              <div>
                ...
                <p className="mt-4 max-w-3xl text-sm leading-7 text-slate-600 md:text-base">
                  {"\u9996\u9875\u5c55\u793a\u4f60\u5728\u5e93\u5b58\u7ba1\u7406\u4e2d\u52fe\u9009\u201c\u9996\u9875\u5c55\u793a\u201d\u7684\u6c34\u679c\uff0c\u5e76\u4f18\u5148\u4f7f\u7528\u4e0a\u4f20\u7684\u4e3b\u56fe\u4f5c\u4e3a\u5c55\u793a\u5c01\u9762\u3002"}
                </p>
              </div>
        ...
        <section className="space-y-4">
          <div className="flex items-end justify-between gap-4">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">{"\u5728\u5e93\u5b58\u7ba1\u7406\u4e2d\u4e0a\u4f20\u4e3b\u56fe\u3001\u8bbe\u7f6e\u5c01\u9762\uff0c\u5e76\u52fe\u9009\u201c\u9996\u9875\u5c55\u793a\u201d\u540e\uff0c\u9996\u9875\u4f1a\u81ea\u52a8\u540c\u6b65\u66f4\u65b0\u3002"}</p>
            </div>
                  ...
                  <article key={item.id} className="overflow-hidden rounded-[28px] border border-slate-200 bg-white shadow-sm">
                    ...
                    <div className="space-y-3 px-5 py-5">
                      ...
                      <div className="flex items-center justify-between text-sm text-slate-500">
                        ...
                        <span>{item.price == null ? "\u4ef7\u683c\u5f85\u8bbe\u7f6e" : currencyFormatter.format(item.price)}</span>
                      </div>
                    </div>
                  </article>
                );
